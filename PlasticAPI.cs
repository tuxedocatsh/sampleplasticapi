...
namespace sampleplasticapi
{
    public static class PlasticAPI
    {
        ...
        internal static string GetRepositoryInformation(string name)
        {
            return ExecuteCommandForOutput("cm lrep --format={1}{4}");
        }
        ...
        internal static bool Update( out string error)
        {
            return ExecuteCommand(string.Format("cm update"), out error);
        }
        ...
        internal static string GetChangeset()
        {
            return ExecuteCommandForOutput("cm status");
        }
